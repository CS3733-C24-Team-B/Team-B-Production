...
class Auth0Utility {
    ...
    private readonly client_secret: string = "kA19mwk08Y0Gso-l2mscK6MpruMuGfXhocBDoOuqzltOnpLYVwp2Yl5GFn1DKuAK";
    ...
    public async setToken() {
        const token = await axios.post(this.domain + "/oauth/token", {
