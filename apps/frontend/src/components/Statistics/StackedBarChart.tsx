...
export default function StackedBarChart() {
  ...
  srData.forEach((item) => {
    ...
    if (
      ...
      normalizedStatus &&
      priorityStatusCounts[priority][normalizedStatus] !== undefined
    ) {
  ...
  const datasets = Object.entries(priorityStatusCounts).map(
    ([priority, statuses]) => ({
      label: priority,
  ...
  return (
    <div>
      <div className={"stacked-bar-title"}>Request Status Data</div>
      <div
        style={{
          width: "90%",
          height: "40vh",
