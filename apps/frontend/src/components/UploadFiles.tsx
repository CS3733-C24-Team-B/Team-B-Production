    ...
    try {
      if (nodeFile) {
        ...
        getAccessTokenSilently().then(async (accessToken: string) => {
          axios
            .post("/api/nodes/upload", formData, {
              headers: {
            ...
            .then(
              () => {
                if (edgeFile) {
                  ...
                  getAccessTokenSilently().then(async (accessToken: string) => {
                    axios
                      .post("/api/edges/upload", formData, {
                        headers: {
                          Authorization: "Bearer " + accessToken,
                          "Content-Type": "multipart/form-data",
                        },
                      ...
                      .then(
                        ...
                        () => {
                          setIsLoading(false);
                          setAlertText(
                            "There was an error uploading the edge data",
                          );
                          setIsError(true);
                          setSubmitAlert(true);
                        },
          ...
          axios
            ...
            .then(
              ...
              () => {
                ...
                setIsLoading(false);
                setAlertText(
                  "There was an error uploading the edge data. You may need to upload the node data first.",
                );
                setIsError(true);
                setSubmitAlert(true);
              },
    ...
    <ThemeProvider theme={theme}>
      ...
      <div className="AD-TwoRows2">
        ...
        <div className="AD-OneCard">
          <Typography
            style={{ marginLeft: "1.5vw", fontWeight: 550, fontSize: "1.35em" }}
          >
            Import Files
          </Typography>
          ...
          <Button
            disabled={isLoading || (!nodeFile && !edgeFile && !employeeFile)}
            sx={{
              marginTop: "0vh",
              backgroundColor:
                isLoading || (!nodeFile && !edgeFile && !employeeFile)
                  ? "lightgray"
                  : "#34AD84",
              color: "white",
              width: "50%",
        ...
        >
          ...
          <DialogActions>
            <Button onClick={dialogDelete} sx={{ color: "#34AD84" }}>
              Yes
            </Button>
            <Button
              onClick={() => {
