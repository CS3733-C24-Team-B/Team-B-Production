...
export default function RequestForm() {
  ...
  async function submit() {
    ...
    if (typeReq === "sanitation") {
      ...
      const res = await axios.post(
        "/api/service-request/sanitation",
        requestSent,
        {
          headers: {
      ...
      const res = await axios.post(
        "/api/service-request/internal-transport",
        requestSent,
        {
          headers: {
            "Content-Type": "application/json",
      ...
      const res = await axios.post(
        "/api/service-request/maintenance",
        requestSent,
        {
          headers: {
            "Content-Type": "application/json",
  ...
  return (
    <div className={"service-form-Container"}>
      ...
      <div className={"service-form-BackBlue"}>
        {" "}
        ...
        >
          <div className={"service-form-topcard"}>
            <Button
              ...
              style={{
                ...
                borderBottom:
                  currentTab === "statistics" ? "1.4vh solid #34AD84" : "white",
                fontFamily: "Lato",
                fontSize: "100%",
                textTransform: "none",
              }}
          ...
          {currentTab === "create-request" && (
            <div className={"service-form-midcard2"}>
              <header
                className={"create-service-header"}
              ...
              >
                ...
                <div className={"requestCardGrid"}>
                  ...
                  <p style={cardText}>
                    For ordering the medicine that patients need directly to
                    their rooms
                  </p>
              ...
              >
                <div className={"requestCardGrid"}>
                  ...
                  <p style={cardText}>
                    For ordering maintenance and general upkeep services to
                    rooms. This request works for all room types
                  </p>
              ...
              >
                <div className={"requestCardGrid"}>
                  ...
                  <p style={cardText}>
                    For transporting patients who need assistance moving from
                    one room to another
                  </p>
              ...
              >
                <div className={"requestCardGrid"}>
                  ...
                  <p style={cardText}>
                    For ordering a translator to assist a patient who doesn't
                    speak the same language as hospital staff
                  </p>
              ...
              >
                <div className={"requestCardGrid"}>
                  ...
                  <p style={cardText}>
                    For requesting cleaning services to rooms for general
                    cleaning or specific instances
                  </p>
              ...
              >
                <div className={"requestCardGrid"}>
                  ...
                  <p style={cardText}>
                    Give Ongoing Knowledge Urgently (GOKU) to all hospital staff
                  </p>
          ...
          >
            <Box sx={modalStyle}>
              ...
              <div className={"modal-div"}>
                  ...
                  <>
                    ...
                    <div className="input-field">
                      <FormControl className="input-field">
                        <InputLabel id="prio-label" variant="standard">
                          Priority
                        </InputLabel>
                        <Select
                        ...
                        >
                          ...
                          <MenuItem value={PriorityType.Medium}>
                            Medium
                          </MenuItem>
                    ...
                    <div className="input-field">
                      <FormControl>
                        <InputLabel id="employee-label" variant="standard">
                          Choose Employee
                        </InputLabel>
                        <Select
                ...
                <div>{renderServiceRequestComponent()}</div>
                {requestType !== "goku" && (
