...
export default function ProfilePage() {
  ...
  function getRequests() {
    ...
    return (
      <div>
        <ul>
          {employee.requestsAssigned.map((obj) => (
            <div>
              ...
              <div style={{ fontSize: 18, marginBlockEnd: 20 }}>
                ...
                <br />
                Location:{" "}
                {obj.location === undefined ? "" : obj.location!.longName}
                <br />
                Notes: {obj.notes}
              </div>
            </div>
            ...
            <div className={"Profile-page-TwoRows"}>
              <div className={"Profile-pic-main-TestCard"}>
                ...
                <div className={"Profile-page-text"}>
                  ...
                  <TextField
                    className={"Profile-page-firstcard-text"}
                    id="standard-basic"
                    label="First Name"
                    variant="outlined"
                    required
                ...
                <div className={"Profile-page-top-infocards"}>
                  ...
                  <div className="TextContainer">
                    ...
                    <div className="Number">
                      <p className={"Profile-page-top-infonumbers"}>
                        {getAssigned()}
                      </p>
                    </div>
                  </div>
              ...
              <div className={"Profile-page-TwoColumnsSecondRow"}>
                ...
                <div className={"Profile-page-TwoColumnsSecondRow-SecondRows"}>
                  <div className={"SecondRow_SecondColumn-TestCard"}>
                    <PieChartStats
                      srlist={employee!.requestsAssigned}
                      title={"My Requests"}
                    />
                  </div>
                  <div className={"SecondRow_SecondColumn-TestCard"}>
