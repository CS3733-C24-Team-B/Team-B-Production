        ...
        <div className={"FiveRows"}>
          ...
          <div className={"AboutTwoColumns"}>
            <div className={"LabelCard"}>
              <p className={"break"}>.</p>
              <p className={"welcome-text"}>WPI Computer</p>{" "}
              <p className={"welcome-text"}>Science Department</p>
              <p className={"break"}>.</p>
              <p className={"course-info"}>CS3733-C24</p>{" "}
              <p className={"course-info"}>Software Engineering</p>
              <p className={"break"}>.</p>
              <p className={"course-info"}>Professor</p>{" "}
              <p className={"name"}>Wilson Wong</p>
              <p className={"break"}>.</p>
              <p className={"course-info"}>Team Coach</p>{" "}
              <p className={"name"}>Ariel Schechter</p>
              <p className={"break"}>.</p>
            </div>
            ...
            <div className={"About-NameColumns"}>
              <div className={"About-TestCard"}>
                ...
                <div className={"TextBox"}>
                  ...
                  <p>
                    WPI class of 2025 Computer Science and Robotics Engineering
                    major.
                  </p>
                </div>
              </div>
              <div className={"About-TestCard"}>
                ...
                <div className={"TextBox"}>
                  ...
                  <h3>
                    Assistant Lead Software Engineer & Algorithms Developer
                  </h3>
              ...
              <div className={"About-TestCard"}>
                ...
                <div className={"TextBox"}>
                  ...
                  <p>
                    WPI class of 2026 Computer Science major and Robotics
                    Engineering and Spanish minor
                  </p>
                </div>
              </div>
              <div className={"About-TestCard"}>
            ...
            <div className={"About-NameColumns"}>
              <div className={"About-TestCard"}>
                ...
                <div className={"TextBox"}>
                  ...
                  <p>
                    WPI class of 2024 Robotics Engineering and Biomedical
                    Engineering major.
                  </p>
                </div>
              </div>
          ...
          <div className={"AcknowledgementCard"}>
            ...
            <p className={"break"}>.</p>
            <p className={"info"}>
              Brigham and Women's Hospital, and representative{" "}
              <a className={"blue-info"}>Andrew Shinn.</a>
            </p>
            <p className={"info"}>
              Icon made by <a className={"blue-info"}>Freepik</a> from{" "}
              <a
