...
export default function NavigationPage() {
  ...
  const [showEdges, setShowEdges] = useState(
    localStorage.getItem("showEdges") !== null
      ? localStorage.getItem("showEdges") === "true"
      : false,
  );
  ...
  const [nodeColor, setNodeColor] = useState(
    localStorage.getItem("nodeColor") !== null
      ? localStorage.getItem("nodeColor")
      : "#3388ff",
  );
  ...
  const [showPopups, setShowPopups] = useState(
    localStorage.getItem("showPopups") !== null
      ? localStorage.getItem("showPopups") === "true"
      : true,
  );
          ...
          <TextField
            ...
            label={
              <p className={"search-label"}>
                Find Your {<span className={"action-text"}>Destination</span>}
              </p>
            }
            variant={"outlined"}
          />
  ...
  const ChooseAlgo = (
    ...
    >
      ...
      >
        {
          <MenuItem value={"A Star"} sx={{ fontFamily: "Lato" }}>
            A*
          </MenuItem>
        }
        {
          <MenuItem value={"BFS"} sx={{ fontFamily: "Lato" }}>
            BFS
          </MenuItem>
        }
        {
          <MenuItem value={"DFS"} sx={{ fontFamily: "Lato" }}>
            DFS
          </MenuItem>
        }
        {
          <MenuItem value={"Dijkstra"} sx={{ fontFamily: "Lato" }}>
            Dijkstra
          </MenuItem>
        }
      </TextField>
    ...
    >
      <Box sx={modalStyle}>
        ...
        <div className={"color-settings"}>
          ...
          <input
            className="Settings-Color-Selector2"
            type="color"
